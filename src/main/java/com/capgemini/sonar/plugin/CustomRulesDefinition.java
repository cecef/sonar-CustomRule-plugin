...
public class CustomRulesDefinition implements RulesDefinition {
    ...
    public static final String REPOSITORY_NAME = "Capgemini rule repository";
    ...
    public void define(Context context) {
        ...
        NewRule interceptorsAnnotation = repository.createRule(InterceptorsAnnotation.KEY)
                .setName(InterceptorsAnnotation.NAME)
                .setHtmlDescription(InterceptorsAnnotation.DESCRIPTION)
                .setTags(InterceptorsAnnotation.TAG)
                .setStatus(RuleStatus.READY)
                .setSeverity(InterceptorsAnnotation.SEVERITY);
